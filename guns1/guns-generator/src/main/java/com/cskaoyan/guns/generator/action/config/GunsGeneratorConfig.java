package com.cskaoyan.guns.generator.action.config;
...
public class GunsGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void globalConfig() {
        ...
        globalConfig.setAuthor("cskaoyan");
    }
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.cskaoyan.guns.admin.common.persistence.model");
        packageConfig.setMapper("com.cskaoyan.guns.admin.common.persistence.dao");
        packageConfig.setXml("com.cskaoyan.guns.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.cskaoyan.guns.admin");
        contextConfig.setCoreBasePackage("com.cskaoyan.guns.core");
