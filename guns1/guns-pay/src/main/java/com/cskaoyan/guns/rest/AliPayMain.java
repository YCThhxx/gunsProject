...
import com.cskaoyan.guns.rest.config.Configs;
import com.cskaoyan.guns.rest.model.ExtendParams;
import com.cskaoyan.guns.rest.model.GoodsDetail;
import com.cskaoyan.guns.rest.model.result.AlipayF2FPayResult;
import com.cskaoyan.guns.rest.model.result.AlipayF2FPrecreateResult;
import com.cskaoyan.guns.rest.model.result.AlipayF2FQueryResult;
import com.cskaoyan.guns.rest.model.result.AlipayF2FRefundResult;
import com.cskaoyan.guns.rest.service.AlipayMonitorService;
import com.cskaoyan.guns.rest.service.AlipayTradeService;
import com.cskaoyan.guns.rest.service.impl.AlipayMonitorServiceImpl;
import com.cskaoyan.guns.rest.service.impl.AlipayTradeServiceImpl;
import com.cskaoyan.guns.rest.service.impl.AlipayTradeWithHBServiceImpl;
import com.cskaoyan.guns.rest.utils.Utils;
import com.cskaoyan.guns.rest.utils.ZxingUtils;
import com.cskaoyan.guns.rest.model.builder.*;
import com.cskaoyan.guns.rest.model.hb.*;
...
//    }
    ...
    // 测试当面付2.0生成支付二维码
    public boolean test_trade_precreate() {
        // (必填) 商户网站订单系统中唯一订单号，64个字符以内，只能包含字母、数字、下划线，
        // 需保证商户系统端不能重复，建议通过数据库sequence生成，
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                // 需要修改为运行机器上的路径
                String filePath = String.format("/Users/user/Desktop/Project_guns/qr-%s.png",
